...
export default {
  ...
  methods: {
    ...
    getAllOrder() {
      ...
      this.$axios
        .post(
          "http://localhost:8080/orderinfo/findAllOrderInfo",
          qs.stringify(params)
        )
        .then(res => {
    ...
    changeStatus(index) {
      this.$axios
        .post(
          "http://localhost:8080/orderinfo/changeStatus",
    ...
    search() {
      ...
      this.$axios
        .post(
          "http://localhost:8080/orderinfo/searchOrderInfo",
          qs.stringify(params)
        )
        .then(res => {
          let resData = res.data;
    ...
    getByTime() {
      this.$axios
        .post("http://localhost:8080/orderinfo/findBySort")
        .then(res => {
          let resData = res.data;
          //console.log(resData);
          if (resData.code === 0) {
    ...
    showDeal() {
      this.$axios
        .post("http://localhost:8080/orderinfo/findDealOrder")
        .then(res => {
          let resData = res.data;
          //console.log(resData);
          if (resData.code === 0) {
    ...
    showUnDeal() {
      this.$axios
        .post("http://localhost:8080/orderinfo/findUndealOrder")
        .then(res => {
          let resData = res.data;
          //console.log(resData);
          if (resData.code === 0) {
    ...
    remove(index) {
      ...
      this.$axios
      .post('http://localhost:8080/orderinfo/delOrderInfo',qs.stringify(params))
      .then(res => {
        let resData = res.data;
        if(resData.code === 0){
          this.$Message.info({
