...
export default {
  ...
  methods: {
    getUserId() {
      ...
      this.$axios
        .post(
          "http://localhost:8080/user/findUserByUserName",
          qs.stringify(params)
        )
        .then(res => {
    ...
    getPhone() {
      ...
      this.$axios
        .post(
          "http://localhost:8080/phoneinfo/findPhoneInfoByUserId ",
          qs.stringify(params)
        )
        .then(res => {
          let resData = res.data;
    ...
    getTrouble() {
      ...
      this.$axios
        .post(
          "http://localhost:8080/troubleinfo/findAllTrouble ",
          qs.stringify(params)
        )
        .then(res => {
          let resData = res.data;
    ...
    handleSubmit() {
      ...
      this.$axios
        .post(
          "http://localhost:8080/orderinfo/addOrderInfo",
          qs.stringify(params)
        )
        .then(res => {
          let resData = res.data;
